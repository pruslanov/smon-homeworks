...
Ctrl+W ищем фразу DBPassword и изменяем параметр `DBPassword=1234546789` на созданный ранне пароль. Сохраняем Clrt+O и закрываем Ctrl+X файл конфигурации
